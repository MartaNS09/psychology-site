...
export function Header() {
  ...
  const headerClass = cn("header", scrolled && "header_scrolled", menuOpen && "header_menu-open");
  ...
  return (
    <>
      <div className="header-anchor">{!isMobile && headerBar}</div>
      {portalReady && isMobile && createPortal(mobileOverlay, document.body)}
    </>
  );
}
